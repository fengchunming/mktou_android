package com.mktou.android.home;
...
import com.mktou.android.common.http.CU_JSONResolve;
import com.mktou.android.common.http.GetHttp;
...
public class WareActivity extends Activity implements OnTouchListener,
		IXListViewListener {
	// 显示所有商品的列表
			...
			if (result != null && result.get("data") != null) {
				...
				arrayList
						.addAll((Collection<? extends HashMap<String, Object>>) result
								.get("data"));
				listView.setAdapter(new Adapter_ListView_ware(
						WareActivity.this, arrayList));
				listView.setOnItemClickListener(new OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> arg0, View arg1,
							int position, long arg3) {
						Intent intent = new Intent(WareActivity.this,
								BabyActivity.class);
