package com.mktou.android.user;
...
public class UserFragment extends Fragment implements OnClickListener {
	...
	private void initView(View view) {
		((TextView) view.findViewById(R.id.tv_top_txtTitle)).setText("我的门口头");
		...
		my_gridView_user.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				// 进入本机拥有传感器界面
				Intent intent = new Intent(getActivity(), HelloSensorActivity.class);
	...
	public void onClick(View arg0) {
		...
		case R.id.ll_user_life:
			// 进入刮刮乐界面
			Intent intent1 = new Intent(getActivity(), UserLotteryActivity.class);
			startActivity(intent1);
			break;
		case R.id.ll_user_members:
			// 进入刮刮乐界面
			Intent intent2 = new Intent(getActivity(), UserLotteryActivity.class);
			startActivity(intent2);
			break;
		case R.id.ll_user_store:
			// 进入刮刮乐界面
			Intent intent3 = new Intent(getActivity(), UserLotteryActivity.class);
			startActivity(intent3);
			break;
		case R.id.ll_user_opinion:
			// 意见反馈界面
			Intent intent4 = new Intent(getActivity(), UserOpinionActivity.class);
