package com.mktou.android.common.view;
...
import com.mktou.android.data.Data;
...
public class BabyPopWindow implements OnDismissListener, OnClickListener {
	private TextView pop_choice_16g, pop_choice_32g, pop_choice_16m,
			pop_choice_32m, pop_choice_black, pop_choice_white, pop_add,
			pop_reduce, pop_num, pop_ok;
	...
	public void onClick(View v) {
		...
		case R.id.pop_ok:
			...
			if (str_color.equals("")) {
				...
				Toast.makeText(context, "亲，你还没有选择类型哟~", Toast.LENGTH_SHORT)
						.show();
			} else {
	...
	private void setSaveData() {
		...
		for (int i = 0; i < Data.arrayList_cart.size(); i++) {
			...
			editor.putString("ArrayCart_type_" + i, Data.arrayList_cart.get(i)
					.get("type").toString());
			editor.putString("ArrayCart_color_" + i, Data.arrayList_cart.get(i)
					.get("color").toString());
			editor.putString("ArrayCart_num_" + i, Data.arrayList_cart.get(i)
					.get("num").toString());
