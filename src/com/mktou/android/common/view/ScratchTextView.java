...
public class ScratchTextView extends TextView {
	 ...
	 *            画线容差
	 */
	public void initScratchCard(final int bgColor, final int paintStrokeWidth,
		...
		mPaint.setStyle(Paint.Style.STROKE);// 画笔类型： STROKE空心 FILL实心
											// FILL_AND_STROKE用契形填充
		...
		mCanvas.drawText("刮开此图层", getLayoutParams().width / 4,
				getLayoutParams().height / 2 + 15, paint);
		isInited = true;
	}
