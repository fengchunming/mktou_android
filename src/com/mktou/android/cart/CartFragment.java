...
public class CartFragment extends Fragment implements OnClickListener {
	...
	private AllBabyFragment allBaby_F;
	private LowBabyFragment lowBaby_F;
	private StockBabyFragment stockBaby_F;
	...
	public void onClick(View v) {
		...
		case R.id.tv_top_edit:
			if (allBaby_F != null && isDel) {
				...
				allBaby_F = null;
				allBaby_F = new AllBabyFragment("删除");
				addFragment(allBaby_F);
				showFragment(allBaby_F);
				isDel = false;
		...
		case R.id.bt_cart_stock:
			if (stockBaby_F == null) {
				stockBaby_F = new StockBabyFragment();
